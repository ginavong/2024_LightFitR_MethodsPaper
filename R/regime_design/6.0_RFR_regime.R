...
out_dir = './data/regimes/fig6_R_FR_demo/'
...
targets = read.csv('./data/algorithm_testing/fig6_R_FR_demo/6_targets.csv')
...
message('6.0.1. Create target matrix')
...
message('6.0.2. Filter calib data')
...
message('6.0.4. Export regime')

fn = paste0(out_dir, '6_RFR_demo.txt')
LightFitR::helio.writeSchedule(RFR_regime, filename=fn, format='json')

fn = paste0(out_dir, '6_RFR_intensities.csv')
