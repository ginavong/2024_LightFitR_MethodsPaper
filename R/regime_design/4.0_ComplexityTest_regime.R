...
#---
# Export
helio.writeSchedule(regime, 'data/regimes/fig4_ComplexityTest/4_ComplexityTest.csv', format='csv')
helio.writeSchedule(regime, 'data/regimes/fig4_ComplexityTest/4_ComplexityTest.txt', format='json')
write.csv(regime, 'data/regimes/fig4_ComplexityTest/4_ComplexityTest_intensities.csv', col.names=F, row.names=T)
